...
class TimelineTimer:
    """
    Timer object that is used to space out the time between api.user_timeline() requests. Default: 1.2 seconds.
    """
    def __init__(self, num_seconds_to_wait=1.2):
...
if __name__ == "__main__":
    ...
    new_list = build_post_list("elonmusk", 100)
